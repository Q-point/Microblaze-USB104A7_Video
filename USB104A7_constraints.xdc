...
set_property -dict {PACKAGE_PIN R12 IOSTANDARD LVCMOS33} [get_ports dspi_io0_io]
set_property -dict {PACKAGE_PIN R13 IOSTANDARD LVCMOS33} [get_ports dspi_io1_io]
set_property -dict {PACKAGE_PIN M13 IOSTANDARD LVCMOS33} [get_ports { dspi_spisel }];  #IO_L6N_T0_D08_14     Sch=prog_d[3]/ss
set_property -dict {PACKAGE_PIN M13 IOSTANDARD LVCMOS33} [get_ports { dspi_ss_io }];  #IO_L6N_T0_D08_14     Sch=prog_d[3]/ss
...
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports iic_scl_io]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports iic_sda_io]

set_property -dict {PACKAGE_PIN C5 IOSTANDARD LVCMOS33} [get_ports CS]
set_property -dict {PACKAGE_PIN C6 IOSTANDARD LVCMOS33} [get_ports SCK]
set_property -dict {PACKAGE_PIN B6 IOSTANDARD LVCMOS33} [get_ports MOSI]
set_property -dict {PACKAGE_PIN C7 IOSTANDARD LVCMOS33} [get_ports MISO]
...
set_property PACKAGE_PIN F4 [get_ports {VGA_R[0]}]
set_property PACKAGE_PIN F3 [get_ports {VGA_R[1]}]
set_property PACKAGE_PIN E2 [get_ports {VGA_R[3]}]
set_property PACKAGE_PIN D2 [get_ports {VGA_R[2]}]

set_property PACKAGE_PIN H2 [get_ports {VGA_B[0]}]
set_property PACKAGE_PIN G2 [get_ports {VGA_B[1]}]
set_property PACKAGE_PIN C2 [get_ports {VGA_B[2]}]
set_property PACKAGE_PIN C1 [get_ports {VGA_B[3]}]

set_property PACKAGE_PIN C4 [get_ports {VGA_G[0]}]
set_property PACKAGE_PIN B2 [get_ports {VGA_G[1]}]
set_property PACKAGE_PIN B3 [get_ports {VGA_G[2]}]
set_property PACKAGE_PIN B4 [get_ports {VGA_G[3]}]

set_property PACKAGE_PIN B1 [get_ports VGA_HS]
set_property PACKAGE_PIN A1 [get_ports VGA_VS]
